...
public class Pc {
    ...
    public void play() {
        ...
        minimax(initialState, 0, xORo);   //after this minimax calling, now Pc knows(perfectRow, perfectCol variables are set) the address of the perfect cell, so pc clicks it
